 ...
 * 
 * Video: https://youtu.be/Ic80xQFWevc
 * Time complexity: O(nlog^2(n))
 *
 * Run on command line:
 * Algorithms$ javac com/williamfiset/algorithms/strings/LongestCommonSubstring.java
 * Algorithms$ java com/williamfiset/algorithms/strings/LongestCommonSubstring
 *
...
public class LongestCommonSubstring {
  ...
  static abstract class SuffixArray {
