/**
 * This file shows you how to use a suffix array to construct the 
 * Longest Common Prefix (LCP) array using the kasai algorithm.
 *
 * Time complexity: O(nlogn) for suffix array construct and O(n)
 * for longest common prefix array construction, so O(nlogn) overall
 *
