/** 
* Given a convex polygon with integer coordinates in CCW order, return whether or not the
* specified point is contained within the polygon or on the boundary. 
