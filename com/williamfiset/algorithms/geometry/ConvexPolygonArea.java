/**
 * This file contains code that can find the area of a
 * convex polygon if the points are given in CW or CCW order.
 *
 * Time Complexity: O(n)
 * 
...
public class ConvexPolygonArea {
  ...
  public static double convexPolygonArea(Point2D[] points) {
    ...
    if (N < 3 || points[0] != points[N])
      throw new IllegalArgumentException("Make sure N >= 3 and that the points array has n+1 points and points[0] = points[N]");
