/**
 * This file shows you how to solve the traveling salesman
 * problem using a brute force approach. Since the time 
 * complexity is on the order of O(n!) this method is not
 * convenient for n > 12
 * 
 * Time Complexity: O(n!)
 *
