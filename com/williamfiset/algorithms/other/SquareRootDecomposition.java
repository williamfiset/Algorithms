/**
 * Range queries in O(sqrt(n)) and point updates in O(1).
 * Currently this implementation supports summing over the
 * entries in the array, but it can be modified to support
