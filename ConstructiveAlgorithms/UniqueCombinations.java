/**
 * This file shows you how to generate all the unique combinations
 * of a set even though some elements may be repeated. For example,
 * if your set is {2, 2, 3, 3, 3} and you care only about sets of size
 * two (r = 2) then the unique sets are {{2,2}, {2,3}, {3,3}}.
 * 
