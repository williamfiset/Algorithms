/**
 * An implementation of the TSP problem using a genetic algorithm.
 * This implementation works well for graph with < 30 nodes, beyond this
 * it seems to struggle getting near the optimal solution.
 *
