/**
 * A custom infinite line class that provides additional
 * functionality beyond Java's Line2D.
 *
...
// A very same epsilon value used as a threshold for double equality
  ...
  public static Point2D intersection(Line l1, Line l2) {
    ...
    if      (abs(l1.b) < EPS) { x = l1.c/l1.a; y = (l2.c - l2.a*x) / l2.b; }
    else if (abs(l2.b) < EPS) { x = l2.c/l2.a; y = (l1.c - l1.a*x) / l1.b; }
    else if (abs(l1.a) < EPS) { y = l1.c/l1.b; x = (l2.c - l2.b*y) / l2.a; }
    else if (abs(l2.a) < EPS) { y = l2.c/l2.b; x = (l1.c - l1.b*y) / l1.a; }
    else { x = (l1.c - l2.c) / (l1.a - l2.a); y = (l1.c - l1.a*x) / l1.b; }
